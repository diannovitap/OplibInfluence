<x-fullsite-layout>
    <div class="p-16">
        ...
        <div class="bg-[#F4F4F4] px-10 pt-10 pb-20 mt-10 rounded-md">
            <h1 class="text-2xl font-bold text-center">Peminjaman Buku melalui Delivery Service</h1>
            <div class="flex gap-10 mt-10">
                <div class="bg-white rounded-lg w-9/12 px-12 py-5">
                    <h1 class="text-xl font-bold">Peminjaman Buku melalui Delivery Service</h1>
                    <div class="mt-5 font-medium">
                        <p>Silahkan untuk mengisi form Peminjaman terlebih dahulu melalui tautan:</p>

                        <br>
                        <p>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSflRQDOU3iIfITGepw5JcldLkDkXTL3uF3EsittFJdKM82h9A/viewform" target="_blank" class="underline text-[#07559F]">bit.ly/PeminjamanOnlineOpenlibTelU</a></p>
                            <div class="mt-5">
                                <div class="flex gap-5 justify-center">
                                    <img src="/assets/pinjambuku1.png" alt="Photo of Peminjaman Buku">
                                    <img src="/assets/pinjambuku2.png" alt="Photo of Peminjaman Buku">
                                </div>
                                <div class="flex gap-5 justify-center mt-4">
                                    <img src="/assets/pinjambuku3.png" alt="Photo of Peminjaman Buku">
                                    <img src="/assets/pinjambuku4.png" alt="Photo of Peminjaman Buku">
                                </div>
                            </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="bg-white py-3 font-medium rounded-b-lg">
                            <div class="flex">
                                ...
                                <p class="text-center w-1/2">23 August 2021</p>
                            </div>
                            <div class="flex">
