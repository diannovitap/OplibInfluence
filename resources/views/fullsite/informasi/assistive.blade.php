            ...
            <div class="flex gap-10 mt-10">
                <div class="bg-white rounded-lg w-9/12 px-12 py-5">
                    ...
                    <div class="mt-5 font-medium">
                        <p>Layanan ini memiliki fitur yang dapat mengubah bahan text bacaan menjadi bentuk audio,
                            sehingga TelUtizen bisa membaca buku dan mendengarkan audionya secara bersamaan. Selain
                            dapat memahami teks melalui fitur audio, layanan ini juga dapat membantu rekan-rekan yang
                            memiliki gangguan penglihatan dalam memahami teks bacaan, khususnya pada platform digital.
                        </p>
                        <br>
                        <ul class="list-disc pl-5">

                            <li><span class="font-bold">Assistive Technology Service</span> merupakan layanan pendukung
                                literasi yang dapat digunakan
                                untuk
                                mengubah text e-book menjadi audio, sebagai alat bantu dalam memahami kata-kata asing
                                (Bahasa Inggris), alat penunjang penelitian ilmiah, alat bantu pengecekan tulisan Bahasa
                                inggris, serta dapat digunakan untuk user yg memiliki keterbatasan pada penglihatan (low
                                vision).</li>
                            <li><span class="font-bold">Text to Speech</span> : Fitur untuk mengubah teks dokumen atau
                                buku elektronik yang dibaca atau
                                diketik, menjadi audio yang dilengkapi dengan fitur highlight untuk memberikan tanda
                                warna
                                atau block pada teks yang tersedia.</li>
                            <li><span class="font-bold">Check It</span> : Fitur yang dapat digunakan untuk memberikan
                            ...
                            <li><span class="font-bold">Translator</span> : Fitur yang mampu menerjemahkan bentuk media
