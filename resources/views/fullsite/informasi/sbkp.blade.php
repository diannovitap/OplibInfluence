<x-fullsite-layout>
    <div class="p-16">
        ...
        <div class="bg-[#F4F4F4] px-10 pt-10 pb-20 mt-10 rounded-md">
            <h1 class="text-2xl font-bold text-center">Surat Bebas Kewajiban Perpustakaan (SBKP)</h1>
            <div class="flex gap-10 mt-10">
                <div class="bg-white rounded-lg w-9/12 p-5">
                    <h1 class="text-xl font-bold">Surat Bebas Kewajiban Perpustakaan (SBKP)</h1>
                    <ul class="list-decimal pl-5 text-[#07559F] font-medium leading-tight mt-5">
                        <li>Sosialisasi Tugas Akhir Mahasiswa Sebagai Sumber Publikasi</li>
                        <li>Syarat Pengajuan Surat Bebas Kewajiban Perpustakaan (SBKP)</li>
                        <li>User Guide, Jenis Dokumen yang harus diupload di Open Library</li>
                        <li>Aturan Umum Tugas Akhir Sebagai Penelitian dan Publikasi di Lingkungan Universitas Telkom
                        </li>
                        <li>Template Surat keterangan Publikasi Eksternal</li>
                        <li>Form Donasi Buku Kolektif</li>
                        <li>Form Cicilan Denda</li>
                    </ul>
                </div>
                <div class="w-3/12">
                    <div>
                        ...
                        <div class="bg-white py-3 font-medium rounded-b-lg">
                            <div class="flex">
                                ...
                                <p class="text-center w-1/2">09 May 2023</p>
                            </div>
                            <div class="flex">
                                <p class="text-center w-1/2">Updated</p>
                                <p class="text-center w-1/2">19 June 2023</p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-10">
